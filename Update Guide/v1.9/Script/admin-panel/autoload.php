        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li <?php echo ($page == 'general-settings' || $page == 'site-settings' || $page == 'payment-settings' || $page == 'email-settings' || $page == 'social-login' || $page == 's3' || $page == 'manage-currencies' || $page == 'live') ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li <?php echo ($page == 'live') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('live'); ?>">Live Stream Settings</a>
                            </li> 
                        </ul>
                    </li>
                    ...
                    <li <?php echo ($page == 'manage-announcements' || $page == 'ban-users' || $page == 'mass-notifications' || $page == 'manage-invitation-keys' || $page == 'auto_subscribe' || $page == 'auto-delete' || $page == 'manage-activities') ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li <?php echo ($page == 'manage-activities') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('manage-activities'); ?>">Manage Activities</a>
                            </li>
                            <li <?php echo ($page == 'mass-notifications') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('mass-notifications'); ?>">Mass Notifications</a>
                            </li>
                            <li <?php echo ($page == 'manage-invitation-keys') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('manage-invitation-keys'); ?>">Manage Invitation Keys</a>
                            </li>
                            <li <?php echo ($page == 'auto_subscribe') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('auto_subscribe'); ?>">Auto Subscribe</a>
                            </li>
                            <li <?php echo ($page == 'auto-delete') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('auto-delete'); ?>">Auto Delete Videos</a>
                            </li>
                        </ul>
                    </li>
